...
<sess poscol=5 poslig=2 destc=7 destl=2 ident=44>
<NouvelleSession nom="AC_TASK_SEQUENCE_3" copieDonneesLocales="NON" fichier="s301_ac.s">
<CheminFichier chemin="COMMUN\ECU\S301_18_AC">
</CheminFichier>
</NouvelleSession>
</sess>
<act poscol=7 poslig=3 destc=5 destl=4 ident=46>
</act>
<sess poscol=5 poslig=4 destc=7 destl=4 ident=47>
<NouvelleSession nom="AVM_TASK_SEQUENCE_3" copieDonneesLocales="NON" fichier="s301_avm.s">
<CheminFichier chemin="COMMUN\ECU\S301_18_AVM">
</CheminFichier>
</NouvelleSession>
</sess>
<act poscol=7 poslig=2 destc=7 destl=3 ident=48>
<Sessions>
...
<act poscol=7 poslig=5 destc=5 destl=6 ident=50>
</act>
<act poscol=7 poslig=6 destc=7 destl=7 ident=52>
<Sessions>
<AttenteDisponibiliteSession>
</AttenteDisponibiliteSession>
</Sessions>
</act>
<act poscol=7 poslig=9 destc=5 destl=10 ident=53>
</act>
<sess poscol=5 poslig=6 destc=7 destl=6 ident=54>
<NouvelleSession nom="HU_TASK_SEQUENCE_4" copieDonneesLocales="NON" fichier="s301_hu.s">
<CheminFichier chemin="COMMUN\ECU\S301_18_HU">
</CheminFichier>
</NouvelleSession>
</sess>
<sess poscol=5 poslig=10 destc=7 destl=10 ident=55>
<NouvelleSession nom="ESCL_TASK_SEQUENCE_3" copieDonneesLocales="NON" fichier="s301_escl.s">
<CheminFichier chemin="COMMUN\ECU\S301_18_ESCL">
</CheminFichier>
</NouvelleSession>
</sess>
...
<act poscol=7 poslig=7 destc=5 destl=8 ident=74>
</act>
<act poscol=7 poslig=8 destc=7 destl=9 ident=75>
<Sessions>
<AttenteDisponibiliteSession>
</AttenteDisponibiliteSession>
</Sessions>
